...
const projection = {
  product: '@singleton-sd/marketing',
  releases: [
    {
      version: '1.1.0',
      date: '2026-08-09',
...
test('accepts JSON that is an exact projection of canonical Markdown', () => {
  assert.doesNotThrow(() =>
    validateProductProjection('@singleton-sd/marketing', markdown, projection),
  );
});
...
test('rejects stale generated JSON', () => {
  ...
  assert.throws(
    () => validateProductProjection('@singleton-sd/marketing', markdown, stale),
...
test('rejects releases that are not newest first', () => {
  assert.throws(
    () =>
      validateProductProjection('@singleton-sd/marketing', markdown, {
        ...projection,
...
test('rejects a single release with a non-semantic version', () => {
  assert.throws(
    () =>
      validateProductProjection('@singleton-sd/marketing', '## not-a-version — 2026-08-09', {
        product: '@singleton-sd/marketing',
